const ElectronicServicesContainer = () => {
  return (
      ...
      <div className="flex-1 flex flex-col items-center justify-start gap-[32px] min-h-[235px]">
        ...
        <div className="self-stretch flex flex-row flex-wrap items-start justify-center gap-[90px] text-center text-lg">
          <div className="relative w-[300px] h-36">
            <div className="absolute top-[0px] left-[208px] rounded bg-white shadow-[0px_5px_25px_rgba(0,_0,_0,_0.1)] w-36 h-36">
            ...
            <div className="absolute top-[0px] left-[0px] rounded bg-white shadow-[0px_5px_25px_rgba(0,_0,_0,_0.1)] w-36 h-36">
          ...
          <div className="relative w-[352px] h-36">
            <div className="absolute top-[0px] left-[208px] rounded bg-white shadow-[0px_5px_25px_rgba(0,_0,_0,_0.1)] w-36 h-36">
...
export default ElectronicServicesContainer;
