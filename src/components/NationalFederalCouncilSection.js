const NationalFederalCouncilSection = () => {
  return (
    <div className="self-stretch flex flex-col items-center justify-start relative gap-[10px] text-right text-13xl text-white font-cairo lg:w-full md:w-full">
      ...
      <div className="my-0 mx-[!important] absolute top-[65px] left-[0px] w-[1439px] flex flex-col items-center justify-start py-0 px-[543px] box-border gap-[32px] z-[1]">
...
export default NationalFederalCouncilSection;
