const NationalCouncilNewsSection = () => {
  return (
    <div className="self-stretch flex flex-col items-center justify-start gap-[32px] text-right text-xs text-burlywood-200 font-cairo">
      ...
      <div className="self-stretch overflow-hidden flex flex-row flex-wrap items-start justify-center gap-[57px]">
        <div className="relative w-[255px] h-[314px] overflow-hidden shrink-0">
          <div className="absolute top-[0px] left-[calc(50%_-_127.5px)] rounded-[5.97px] bg-white shadow-[0px_5px_5px_rgba(0,_0,_0,_0.15)] w-[255px] h-[314px]" />
          <img
        ...
        <div className="relative w-[255px] h-[314px] overflow-hidden shrink-0">
          <div className="absolute top-[0px] left-[calc(50%_-_127.5px)] rounded-[5.97px] bg-oldlace shadow-[0px_0px_0px_rgba(130,_130,_130,_0.15),_0px_5px_20px_rgba(0,_0,_0,_0.2)] w-[255px] h-[314px]" />
          <img
            className="absolute top-[1px] left-[0px] rounded-t-lg rounded-b-none w-[255px] h-[155px] object-cover"
            alt=""
            src="/image-63346084@2x.png"
...
export default NationalCouncilNewsSection;
