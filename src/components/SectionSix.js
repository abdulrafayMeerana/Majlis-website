const SectionSix = () => {
  return (
    <div className="self-stretch flex flex-col items-center justify-start py-0 px-8 box-border gap-[40px] min-h-[169.58999633789062px] text-center text-5xl text-burlywood-200 font-cairo">
      <h1 className="m-0 relative text-inherit leading-[40px] font-semibold font-inherit">
        روابط مفيدة
      </h1>
      <section className="self-stretch flex flex-row flex-wrap items-center justify-start gap-[36px] min-h-[89.58999633789062px]">
        <img
